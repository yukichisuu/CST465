...
namespace OregonMobileHealthCareWebProject.Account
{
    public partial class ViewRegistrationData : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            profile.LoadProfile(Membership.GetUser().ProviderUserKey.ToString(), data);

            uxUserName.Text = data.UserName;
            uxFirstName.Text = data.FirstName;
            uxLastName.Text = data.LastName;
            uxGender.Text = data.Gender;
            uxPassword.Text = data.Password;
            uxEmail.Text = data.EmailAddress;
        }
    }
}